                    ...
                    <?php if($status != 'HR Manager'): ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu"  style="background-color: #ff6d00; top: 58px;">
                                <?php if($status == 'Admin' || $status == 'HR Manager'): ?>
                                    <li> <a tabindex="-1" href="/user/all">Users</a> </li>
                                <?php endif; ?>
                                <?php if($status == 'Admin' || $status == 'Supervisor'): ?>
                                    <li> <a tabindex="-1" href="/client/all">Clients</a> </li>
                                <?php endif; ?>
                                <?php if($status == 'Admin' || $status == 'Supervisor' || $status == 'Lead' || $status == 'Developer' || $status == 'QA Engineer'): ?>
