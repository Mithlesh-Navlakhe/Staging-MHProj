...
<div id="conteiner" class="container" data-date="<?= isset($date)? $date : '' ?>"
	...
	<div class="row col-md-12">
		<?php if(empty($date) || !$dayReport->count()): ?>
		...
		<?php if($status == 'Lead' || $status == 'Developer' || $status == 'QA Engineer'): ?>
			<?php if(empty($date) || !$dayReport->count() || $flag == 0): ?>
			...
			<div class="block-content collapse in">
						...
						<?php if(isset($dayReport)): ?>
							<?php $__currentLoopData = $dayReport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
								<tr class="odd gradeX">
									...
									<td class="check-box-center"><?php echo e(isset($key->billable) ? (($key->billable == 1) ? 'YES' : 'NO') : ''); ?></td>
									<td class="check-box-center"><?php echo e($key->total); ?></td>
									<td class="check-box-center"><?php echo e($key->value); ?></td>
								</tr>
				...
				<div class="row">
					<div class="info-block padding-left-fifteen">
						<strong>Total</strong>
						<strong>Hours: <span id="total-hour"><?php echo e($total['totalTime']); ?></span></strong> |
						<strong>Value: <span id="total-value"><?php echo e($total['totalValue']); ?></span> </strong>
					</div>
				</div>
			</div>
