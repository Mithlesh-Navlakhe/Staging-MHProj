                ...
                <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse open-menu" >
                    ...
                    @endif
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-my dropdown-menu-style">
                                @if ($status == 'Admin' || $status == 'HR Manager' || $status == 'Super Admin')
                                ...
                                @endif
                                @if ($status == 'Super Admin' || $status == 'Admin' || $status == 'Supervisor' || $status == 'Lead' || $status == 'Developer' || $status == 'QA Engineer')
